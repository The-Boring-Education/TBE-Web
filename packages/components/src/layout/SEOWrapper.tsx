import { type AppIdentifier, getAppIdentifierFromDomain, getSEOMeta } from '@tbe/constants';
...
const SEOWrapper = ({ 
  ...
  const detectedAppId = appId || getAppIdentifierFromDomain(
