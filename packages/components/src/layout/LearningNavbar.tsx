...
const LearningNavbar = ({ backHref, onMenuToggle, headerCenterContent, headerRightContent }: LearningNavbarProps) => {
            ...
            <nav className="relative flex items-center justify-between h-full px-[12px] lg:px-[32px] border-0">
                ...
                <div className="flex items-center gap-[16px] min-w-0">
                    ...
                    {onMenuToggle && (
                        ...
                        >
                            <Bars3Icon aria-hidden="true" className={`h-[16px] w-[16px] ${theme === "dark" ? "text-white" : "text-black"}`} />
                        </button>
                    )}
                </div>
