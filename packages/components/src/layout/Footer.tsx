...
import { LINKS, products, routes } from '@tbe/constants';
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8'>
          ...
          <div className='lg:col-span-2'>
            ...
            <Text className='text-gray-300 mb-4 max-w-md' level='p'>
              Making tech education accessible for everyone. Learn, build, and
              grow with our comprehensive platform designed for students and
              professionals.
            </Text>
