...
const DEFAULT_DEMO_OUTPUTS: Record<number, string[]> = {
  0: [
...
export function Terminal({
  commands = DEFAULT_DEMO_COMMANDS,
  outputs = DEFAULT_DEMO_OUTPUTS,
  username = "the-boring-education",
  windowTitle,
  className,
  typingSpeed = 50,
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "mx-auto w-full max-w-5xl px-2 sm:px-4 font-mono text-xs",
        className,
      )}
    >
      <div className="overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900 shadow-2xl">
        ...
        <div className="flex items-center gap-2 bg-neutral-800 px-4 py-2.5">
          <div className="flex items-center gap-1.5">
            ...
            <div className="h-2.5 w-2.5 rounded-full bg-yellow-500 transition-colors hover:bg-yellow-600" />
            <div className="h-2.5 w-2.5 rounded-full bg-green-500 transition-colors hover:bg-green-600" />
          </div>
          <div className="flex-1 text-center">
            <span className="truncate text-xs text-neutral-400">
              {windowTitle || `${username} — bash`}
            </span>
          </div>
        ...
        <div
          ref={contentRef}
          className="h-80 overflow-y-auto p-4 sm:p-5 font-mono [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-neutral-700/60 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-neutral-500"
        >
          {lines.map((line, i) => (
          ...
          {phase === "typing" && (
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span className="ml-0.5 inline-block h-4 w-[2px] bg-neutral-200 rounded-full align-middle" />
            </div>
          )}
          ...
          {(phase === "done" ||
            ...
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span
                className={cn(
                  "ml-0.5 inline-block h-4 w-[2px] bg-neutral-200 rounded-full align-middle transition-opacity duration-100",
