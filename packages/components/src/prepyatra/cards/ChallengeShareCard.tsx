...
import type { SocialMediaTemplateData } from "@tbe/utils";
import { generateSocialMessage } from "@tbe/utils";
import {
  Calendar,
  Copy,
  Facebook,
...
const ChallengeShareCard = ({
  ...
  return (
    <Card className={`glass border-greyLight ${className}`}>
      <CardHeader>
        ...
        <CardDescription className="text-greyDark">
          Share your learning journey and inspire others to start their own
          challenges
        </CardDescription>
      </CardHeader>
