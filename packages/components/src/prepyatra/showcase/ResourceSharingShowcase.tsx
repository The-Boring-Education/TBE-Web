      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-greyDark max-w-3xl mx-auto">
            Discover and share valuable resources with the community. Learn from
            others' experiences and contribute your own insights.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-greyDark text-sm">•</span>
