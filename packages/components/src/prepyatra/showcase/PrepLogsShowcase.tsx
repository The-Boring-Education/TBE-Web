import { Card, CardContent, CardHeader, CardTitle } from "@tbe/components";
  ...
  const prepLogs = [
    {
      ...
      progress: 85,
      notes:
        "Studied different load balancing algorithms. Need to practice designing for high availability.",
    ...
    },
    {
      ...
      progress: 70,
      notes:
        "Solved 3 DP problems. Still struggling with optimization, need more practice.",
    ...
    },
    {
      ...
      progress: 90,
      notes:
        "Practiced STAR method responses. Feeling confident about leadership examples.",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-greyDark max-w-3xl mx-auto">
            Track your preparation journey, monitor progress, and never lose
            sight of your learning goals.
          </p>
        </div>
          ...
          <div className="space-y-6">
            {prepLogs.map((log, index) => (
              ...
              >
                ...
                <CardContent>
                  <p className="text-greyDark mb-4">{log.notes}</p>
