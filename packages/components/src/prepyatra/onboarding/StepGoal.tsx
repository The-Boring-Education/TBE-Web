...
const StepGoal: React.FC<Props> = ({ formData, handleInputChange }) => (
  <div className="space-y-6">
    <div className="text-center mb-8">
      ...
      <p className="text-gray">When are you planning to crack your next job?</p>
    </div>
    <div className="space-y-3">
      {GOALS.map((goal) => (
        <button
          ...
          type="button"
          onClick={() =>
            handleInputChange("goal", goal.value as OnboardingGoalType)
          }
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray">{goal.description}</div>
            </div>
          </div>
        </button>
      ))}
