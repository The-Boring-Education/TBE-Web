          ...
          <Card className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-yellow-500/30">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-greyDark mb-4">
                You've successfully completed all {challenge.totalDays} days of
                your challenge. This is a testament to your dedication and
                consistency!
              </p>
        ...
        {!showSocialPreview ? (
          <>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="progressText" className="text-contentLight">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("progressText", e.target.value)
                  }
              ...
              <Card className="bg-white/30 border-greyLight">
                ...
                <CardContent className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-greyDark">Current Day:</span>
                    <span className="text-contentLight">
                      {challenge.currentDay + 1}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-greyDark">Next Day:</span>
                    <span className="text-contentLight">{nextDay + 1}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-greyDark">Total Days:</span>
                    <span className="text-contentLight">
                      {challenge.totalDays}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="text-contentLight">
                      {Math.round((nextDay / challenge.totalDays) * 100)}%
                    </span>
                  </div>
                </CardContent>
              </Card>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-greyDark">
                Choose a template to share your Day {nextDay + 1} progress
              </DialogDescription>
            </DialogHeader>
                      ...
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          if (textareaRef.current) {
                            textareaRef.current.value =
                              textareaRef.current.value || "";
                            generateSocialMessageFromTemplate(index);
                          }
                        }, 100);
                      }}
                    >
