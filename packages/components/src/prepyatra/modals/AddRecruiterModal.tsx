...
export const AddRecruiterModal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        "📦 SENDING PAYLOAD:",
        editContact ? { recruiterId: editContact._id, ...formData } : payload,
      );
  ...
  "
      >
        <DialogHeader pb-2 pt-1>
          ...
          <Text
            level="h3"
            className="text-contentLight text-base font-semibold leading-tight"
          >
            {editContact
        ...
        <form onSubmit={handleSubmit} className="space-y-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
            ...
            <div className="flex gap-2 flex-col">
              <Label htmlFor="applicationStatus" className="text-contentLight">
                {" "}
                Status
              </Label>
              <select
                ...
                onChange={(e) =>
                  handleInputChange("applicationStatus", e.target.value)
                }
