import { COMPANY_TYPES, GOALS, INTERVIEW_CATEGORIES } from "@tbe/constants";
import type {
  ExperienceLevel,
  InterviewCategory,
      ...
      if (result.status) {
        ...
        if (result.data?.prepYatraUser) {
          const updatedData = {
            ...
            interviewCategories:
              result.data.prepYatraUser.preferences?.interviewCategories || [],
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-greyDark text-center mt-1">
              💡 Tip: Select more than 1 categories that align with your career
              goals
            </p>
          </div>
