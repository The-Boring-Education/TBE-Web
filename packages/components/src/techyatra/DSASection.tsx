  ...
  const preparationSteps = [
    {
      ...
      description:
        "Start with basic programming concepts and time/space complexity",
      duration: "Week 1-2",
    ...
    },
    {
      ...
      description:
        "Practice with peers, use platforms like Pramp, InterviewBit",
              ...
              >
                ...
                <div className="flex gap-2 mt-2">
                  <Badge
                    variant="outline"
                    className={
                      selectedGoal === goal.id ? "border-white text-white" : ""
                    }
                  >
                    {goal.duration}
                  </Badge>
              ...
              >
                ...
                <CardHeader>
                  <div className="flex items-center mb-2">
                    <div
                      className={`w-8 h-8 bg-gradient-to-r ${step.gradient} rounded-full flex items-center justify-center text-white font-bold text-sm mr-3`}
                    >
                      {step.step}
                    </div>
              ...
              <CardContent>
                <div className="mb-6">
                  <h5 className="font-semibold text-gray-800 mb-3">
                    Topics to Cover (Click to see questions):
                  </h5>
                  <div className="flex flex-wrap gap-3">
                    {topicsByGoal[
                      selectedGoal as keyof typeof topicsByGoal
                    ]?.map((topic) => (
                      <button
                        key={topic.id}
                        onClick={() =>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="bg-white p-4 rounded-lg shadow-sm border borderColor2 transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:border-purple-400">
                    ...
                    <p className="text-gray-600">
                      Ways to organize and store data (Arrays, Trees, Graphs,
                      etc.). Think of them as containers with specific rules.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm border borderColor2 transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:border-purple-400">
                    ...
                    <p className="text-gray-600">
                      Step-by-step procedures to solve problems (Sorting,
                      Searching, Dynamic Programming, etc.).
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm border borderColor2 transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:border-purple-400">
                    ...
                    <p className="text-gray-600">
                      Common problem-solving techniques (Two Pointers, Sliding
                      Window, etc.) that work across multiple problems.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Choose one topic from above (e.g., Arrays). Don't jump
                      around - master one before moving to the next.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-green-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Ask ChatGPT: "Explain [topic] with examples and when to
                      use it." Read until you understand the concept clearly.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Start with Easy problems from the topic. Use
                      LeetCode/HackerRank. If stuck, ask ChatGPT for hints, not
                      solutions.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-orange-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Identify common patterns in problems. Ask ChatGPT: "What
                      are common patterns for [topic] problems?"
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-red-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Solve 3-5 problems daily. Review previous problems weekly.
                      Move to next topic only after mastering current one.
                    </p>
                  </div>
                </div>
              </CardContent>
