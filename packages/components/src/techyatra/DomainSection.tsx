            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <Badge
                    variant={domain.beginnerFriendly ? "default" : "secondary"}
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Badge
                    variant={
                      domain.jobDemand === "High" ? "default" : "secondary"
                    }
                  >
                    {domain.jobDemand}
                  </Badge>
              ...
              {expandedDomain === domain.id && (
                <div className="mt-6 pt-4 border-t space-y-4 animate-fade-in">
                  <div>
                    ...
                    <Badge
                      variant={domain.remoteFriendly ? "default" : "secondary"}
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {domain.courseLinks &&
                        domain.courseLinks.map((course, index) => (
                          <button
                            key={index}
                            onClick={(e) => {
                              e.stopPropagation();
                      ...
                      <div className="text-sm text-gray-600 space-y-1">
                        {domain.whereToLearn
                          .slice(domain.courseLinks?.length || 0)
                          .map((resource, index) => (
