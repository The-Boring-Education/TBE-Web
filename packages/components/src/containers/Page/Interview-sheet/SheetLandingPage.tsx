            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="flex items-center gap-2 text-red-200">
                <LinkButton
                  buttonProps={{
                    ...
                    className:
                      "bg-white text-red-600 hover:bg-gray-100 text-sm px-3 py-1 rounded border",
                  }}
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    ~{Math.ceil((sheet.questions?.length || 0) * 2)} minutes
                  </span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg border p-5">
                <Text className="text-xl font-bold mb-3" level="h2">
                  About This Sheet
                </Text>
              ...
              {sheet?.features && sheet.features.length > 0 && (
                <div className="bg-white rounded-lg border p-5">
                  <Text className="text-xl font-bold mb-3" level="h3">
                    What You'll Learn
                  </Text>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {sheet.features.map((feature, index) => (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <Text level="p" className="text-gray-700">
                          {feature}
                        </Text>
                      </div>
                    ))}
                  ...
                  {isPurchased && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                      <div className="flex items-center justify-center gap-2 text-green-700 mb-2">
                        ...
                        <Text level="p" className="text-sm font-medium">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-6 space-y-4">
                            ...
                            : isPurchased
                              ...
                              : canStartNow
                                ...
                                : !sheet?.isEnrolled && !sheet?.isPremium
                                  ? "Enroll Free"
                                  : priceBreakdown
                                    ? `Purchase Access - ${formatPrice(priceBreakdown.finalPrice)}`
                                    : "Purchase Access"
                        }
                        variant={isPurchased ? "SUCCESS" : "PRIMARY"}
                ...
                <div className="bg-white rounded-lg border p-4">
                  <Text level="p" className="font-semibold mb-3">
                    This sheet includes:
                  </Text>
