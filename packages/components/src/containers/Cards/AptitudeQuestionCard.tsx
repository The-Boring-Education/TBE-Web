            ...
            <div className="space-y-1.5 mb-4">
                {question.options?.map((opt, idx) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`flex items-center justify-center min-w-[22px] w-[22px] h-[22px] rounded border text-[11px] font-black shrink-0 transition-all duration-300 ${isAnswered
                                    ? opt.isCorrect
