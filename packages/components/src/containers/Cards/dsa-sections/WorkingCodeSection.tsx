...
interface WorkingCodeSectionProps {
                ...
                <div className="flex border-b border-gray-800 bg-[#161616] overflow-x-auto">
                    {availableLanguages.map((lang) => (
                        <button
                            ...
                            className={`px-3 py-2 text-xs font-mono transition-colors duration-200 whitespace-nowrap border-b-2 ${activeLanguage === lang
