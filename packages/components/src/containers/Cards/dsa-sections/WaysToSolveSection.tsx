...
interface WaysToSolveSectionProps {
...
const defaultStyle = { bg: "bg-blue-950/20", text: "text-blue-400", border: "border-blue-900/40" };
                        ...
                        >
                            ...
                            <div className="px-3 py-2 bg-[#161616] border-b border-gray-800 flex items-center justify-between gap-2">
                                <Text level="span" className="text-sm font-semibold text-white">
                                    {approach.approach_number}. {approach.name}
                                </Text>
                                <span
                            ...
                            <div className="px-3 pb-2.5 grid grid-cols-2 gap-2">
                                <div className="bg-[#111] border border-gray-800 rounded p-2">
                                    ...
                                    <Text level="span" className="text-red-400 font-mono text-xs font-bold">
                                        {approach.time_complexity}
                                    </Text>
                                    <Text level="p" className="text-gray-500 text-[10px] mt-0.5 leading-snug">
                                        {approach.time_reason}
                                    </Text>
                                </div>
                                <div className="bg-[#111] border border-gray-800 rounded p-2">
                                    <Text
                                    ...
                                    <Text level="p" className="text-gray-500 text-[10px] mt-0.5 leading-snug">
                                        {approach.space_reason}
                                    </Text>
                                </div>
                            </div>

                            {/* Verdict label */}
                            <div className={`px-3 py-1.5 border-t ${style.border} ${style.bg}`}>
                                <Text level="p" className={`text-xs ${style.text}`}>
                                    {approach.verdict_label}
                                </Text>
                            </div>
                        </div>
                    );
