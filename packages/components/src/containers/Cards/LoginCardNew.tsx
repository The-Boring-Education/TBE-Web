    ...
    <Section className="md:px-4 md:py-4 px-2 py-2">
      <FlexContainer className="m-auto" justifyCenter itemCenter>
        ...
        >
          ...
          <div
            className={`w-full md:w-1/2 p-4 md:p-3 flex border-1 ${theme === "dark" ? "border-gray-700 bg-[#0A0A0A]" : "border-gray-200 bg-white"} flex-col items-center justify-center text-center`}
          >
            <motion.div
