        ...
        <div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-3 sm:p-4 border border-blue-200'>
          <div className='flex flex-col sm:flex-row items-start gap-3'>
            ...
            <div className='flex-1 text-center sm:text-left'>
              ...
              <Text level='p' className='text-gray-700 leading-relaxed text-sm'>
                {course.description ||
            ...
            {reasonsToBuy.map(({ icon: Icon, title, description }, index) => (
              ...
              >
                ...
                <div className='min-w-0'>
                  <Text level='h5' className='font-semibold text-gray-900 mb-1 text-sm'>
                    {title}
                  </Text>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                {(course.features && course.features.length > 0
                  ...
                  >
                    ...
                    <Text level='p' className='text-gray-700 font-medium text-sm'>
                      {feature}
                    </Text>
                  </div>
                ))}
        ...
        <div className='bg-purple-50 border border-purple-200 rounded-lg p-3'>
          ...
          <div className='space-y-2'>
            <div className='flex items-center gap-2 bg-white rounded-lg p-2 border border-purple-200'>
              ...
              <div className='min-w-0'>
                <Text level='p' className='text-gray-900 font-semibold text-sm'>
                  {user?.name}
                </Text>
