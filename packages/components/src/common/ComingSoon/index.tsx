    ...
    try {
      const { status } = await makeRequest({
        ...
        body: {
          ...
          eventDescription:
            "User interested in webapp subscription from home page",
          metadata: {
            page: "home",
      ...
      <FlexContainer justifyCenter={false}>
        <FlexContainer className="w-full gap-6 rounded-lg bg-white border border-gray-200 md:px-8 md:py-8 px-4 py-6 shadow-sm">
          ...
          <FlexContainer
            direction="col"
            itemCenter={false}
            className="flex-1 lg:text-left gap-2"
          >
            <FlexContainer
              className="gap-1"
              direction="col"
            ...
            >
              ...
              <Text className="paragraph text-gray-600" level="p">
                Get ready for the ultimate learning experience with premium
                features designed for serious learners.
              </Text>
            </FlexContainer>

            <FlexContainer
              className="mb-6 text-left w-full max-w-md gap-3"
              itemCenter={false}
              justifyCenter={false}
            >
              <FlexContainer
              ...
              <FlexContainer
                className="text-left w-full max-w-md gap-2"
                direction="col"
                itemCenter={false}
                justifyCenter={false}
              >
