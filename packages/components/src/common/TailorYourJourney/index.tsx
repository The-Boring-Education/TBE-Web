// @ts-ignore
import tailorJourneyImg from "./tailor-journey.png";
  ...
  >
    <div className="flex flex-col items-center gap-12 lg:flex-row">
      <div className="flex-1 space-y-6">
        ...
        <ul className="space-y-4 text-left text-gray-700 dark:text-gray-300">
          ...
          <li className="flex items-center gap-3">
            ...
            <span>
              <strong>Define your timeline:</strong> Options from 2 to 12 months
            </span>
          </li>
          <li className="flex items-center gap-3">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/20 text-primary">
      ...
      <div className="flex w-full flex-1 justify-center lg:justify-end">
        <img
          src={
            typeof tailorJourneyImg === "object"
              ? tailorJourneyImg.src
              : tailorJourneyImg
          }
