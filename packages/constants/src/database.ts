...
export const LEADERBOARD_ENUM = ["DAILY", "WEEKLY", "MONTHLY"] as const;
...
export const JOB_SKILL_NORMALIZER = [
  ...
  {
    label: ["JavaScript", "JS", "ECMAScript", "ES6", "ES2015"],
    value: "javascript",
  },
  ...
  {
    label: ["Jest", "Testing", "Unit Test", "Mocha", "Chai"],
    value: "testing",
  },
  {
    label: ["Selenium", "Cypress", "Playwright", "Test Automation"],
    value: "automation-testing",
  },
  { label: ["Figma", "Adobe XD", "Sketch"], value: "design-tools" },
  { label: ["Postman", "API Testing", "Insomnia"], value: "api-tools" },
  {
    label: ["Jira", "Confluence", "Project Management"],
    value: "project-mgmt",
  },
  ...
  {
    label: ["Machine Learning", "ML", "Deep Learning"],
  ...
  {
    label: ["Power BI", "PowerBI", "Tableau", "Data Visualization"],
    value: "data-viz",
  },
];
...
// Resume Evaluation Constants (deprecated - use JOB_EXPERIENCE_LEVEL from global.ts)
const EXPERIENCE_LEVEL_STRINGS = [
  "Fresher (0 yrs)",
...
export type ExperienceLevelType = (typeof EXPERIENCE_LEVEL_STRINGS)[number];
