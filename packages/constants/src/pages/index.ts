...
const PRODUCTS: PrimaryCardWithCTAProps[] = [
  ...
  {
    id: "oncampus",
    image: `${STATIC_FILE_PATH.svg}/oncampus.svg`,
    imageAltText: products.oncampus!.label,
    title: products.oncampus!.label,
    content: products.oncampus!.description,
    href: products.oncampus!.slug,
    active: true,
    ctaText: "Explore On Campus",
    target: "_blank",
  },
  {
    id: "resume-yatra",
  ...
  // Remaining Products
  {
    ...
    href: toPlatformUrl(routes.webinar),
    active: true,
...
const TBP_PROJECTS: PrimaryCardWithCTAProps[] = [
  {
    ...
    href: toPlatformUrl(routes.allProjects.pharmashiftI),
    active: true,
...
const INTERVIEW_PREP_SHEETS: PrimaryCardWithCTAProps[] = [
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.javascriptInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.reactInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.nodeInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.dbInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.pythonInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.javaInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
  {
    ...
    href: toPlatformUrl(routes.allInterviewSheets.dsaInterviewSheet),
    active: true,
    ctaText: "View Sheet",
  },
];
