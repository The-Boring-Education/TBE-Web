...
describe('Shiksha API - /api/v1/shiksha', () => {
    ...
    describe('GET /api/v1/shiksha', () => {
        it('should return all courses', async () => {
            const mockCourses = [
                createMockCourse('1', { slug: 'javascript-basics', title: 'JavaScript Basics' }),
                createMockCourse('2', { slug: 'react-advanced', title: 'Advanced React' }),
            ];
        ...
        it('should return course by slug', async () => {
            const mockCourse = { _id: '1', slug: 'javascript-basics', title: 'JavaScript' };
