...
describe('Discount Utilities', () => {
    const createMockSheet = (overrides: Partial<InterviewSheetModel> = {}): InterviewSheetModel => ({
    ...
    const createMockCoupon = (overrides: Partial<CouponModel> = {}): CouponModel => ({
    ...
    describe('calculatePriceBreakdown', () => {
        ...
        it('should ensure final price is never negative', () => {
            ...
            const coupon = createMockCoupon({ discountPercentage: 100, isValid: true });
    ...
    describe('getDiscountDisplayInfo', () => {
        ...
        it('should show coupon info when coupon is applied', () => {
            ...
            const coupon = createMockCoupon({ code: 'SAVE20', discountPercentage: 20 });
