...
vi.mock('../../../../api/src/lib/database', () => ({
    getQuizCategoriesFromDB: (...args: any[]) => mockGetQuizCategoriesFromDB(...args),
    getQuizCategoriesWithCountsFromDB: (...args: any[]) => mockGetQuizCategoriesWithCountsFromDB(...args),
    addAQuizToDB: (...args: any[]) => mockAddAQuizToDB(...args),
    appendQuestionsToQuizInDB: (...args: any[]) => mockAppendQuestionsToQuizInDB(...args),
}));
