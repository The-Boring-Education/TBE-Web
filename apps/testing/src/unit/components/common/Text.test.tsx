...
describe('Text Component', () => {
    ...
    describe('Variants', () => {
        it('should apply SUCCESS variant', () => {
            const { container } = render(
                <Text level="p" variant="SUCCESS">Success Text</Text>
            );
        ...
        it('should apply ERROR variant', () => {
            const { container } = render(
                <Text level="p" variant="ERROR">Error Text</Text>
            );
    ...
    describe('Props', () => {
        it('should apply custom className', () => {
            const { container } = render(
                <Text level="p" className="custom-class">Text</Text>
            );
        ...
        it('should center text when textCenter is true', () => {
            const { container } = render(
                <Text level="p" textCenter={true}>Centered</Text>
            );
        ...
        it('should not center text when textCenter is false', () => {
            const { container } = render(
                <Text level="p" textCenter={false}>Not Centered</Text>
            );
            const text = container.querySelector('.text-center');
