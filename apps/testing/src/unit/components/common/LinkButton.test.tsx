...
describe('LinkButton Component', () => {
    ...
    describe('Props', () => {
        it('should apply custom className', () => {
            const { container } = render(
                <LinkButton href="/test" className="custom-class" buttonProps={{ text: 'Button' }} />
            );
        ...
        it('should handle target prop', () => {
            const { container } = render(
                <LinkButton href="/test" target="_blank" buttonProps={{ text: 'Button' }} />
            );
        ...
        it('should apply dark theme when theme is dark', () => {
            const { container } = render(
                <LinkButton href="/test" theme="dark" buttonProps={{ text: 'Button' }} />
            );
            const button = container.querySelector('button');
        ...
        it('should not apply dark theme when theme is not dark', () => {
            const { container } = render(
                <LinkButton href="/test" theme="light" buttonProps={{ text: 'Button' }} />
            );
            const button = container.querySelector('button');
    ...
    describe('Loading State', () => {
        ...
        it('should not show loader when noLoader is true', () => {
            const { container } = render(
                <LinkButton href="/test" noLoader={true} buttonProps={{ text: 'Button' }} />
            );
            const link = container.querySelector('a');
            if (link) {
                fireEvent.click(link);
    ...
    describe('Active State', () => {
        it('should render link when active is true', () => {
            const { container } = render(
                <LinkButton href="/test" active={true} buttonProps={{ text: 'Button' }} />
            );
            const link = container.querySelector('a');
            expect(link).not.toBeNull();
        });
        ...
        it('should render link when active is false', () => {
            const { container } = render(
                <LinkButton href="/test" active={false} buttonProps={{ text: 'Button' }} />
            );
            const link = container.querySelector('a');
            expect(link).not.toBeNull();
        });
