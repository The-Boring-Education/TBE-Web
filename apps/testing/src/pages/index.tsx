          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                View Lighthouse reports, validate meta tags, and monitor SEO
                scores across all TBE apps.
              </p>
            </Link>
            ...
            <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-200 opacity-60">
              ...
              <p className="text-gray-600 text-sm">
                ...
                <code className="bg-gray-100 px-1 rounded">pnpm test:unit</code>
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-200 opacity-60">
              ...
              <p className="text-gray-600 text-sm">
                ...
                <code className="bg-gray-100 px-1 rounded">pnpm test:api</code>
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 p-6 bg-gray-900 rounded-lg text-white">
            ...
            <div className="space-y-2 font-mono text-sm">
              <div className="flex gap-4">
                <span className="text-gray-400 w-40">Run SEO Audit:</span>
                <span className="text-green-400">pnpm seo:audit</span>
              </div>
              <div className="flex gap-4">
                <span className="text-gray-400 w-40">SEO Audit (Prod):</span>
                <span className="text-green-400">pnpm seo:audit:prod</span>
              </div>
              <div className="flex gap-4">
                <span className="text-gray-400 w-40">All Tests:</span>
                <span className="text-green-400">pnpm test:ci</span>
              </div>
            </div>
          </div>
        </div>
