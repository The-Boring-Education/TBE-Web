    ...
    return (
        <html lang='en'>
            <head>
                ...
                <meta
                    name='description'
                    content='Master tech interviews with confidence. Practice with carefully curated questions covering JavaScript, React, algorithms, and web development.'
                />
                <meta
                    name='viewport'
