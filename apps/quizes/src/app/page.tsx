  ...
  return (
    <div className='min-h-screen bg-white text-black'>
      ...
      {!loading && !isRedirecting && (
        <>
        {/* Hero Section with Left Theme Colors */}
    ...
    <div className='grid lg:grid-cols-2 gap-16 items-center mb-20'>
      <div>
        <h2 className='text-4xl md:text-5xl font-bold mb-6 leading-tight text-black'>
          ...
          <span className='block text-[#EF4F48]'>
            Confidence
          </span>
        </h2>
        <p className='text-lg text-gray-700 mb-8 leading-relaxed'>
          Practice with carefully curated questions covering JavaScript, React, algorithms, and web development. Get detailed explanations and track your progress.
        </p>
        <button
          ...
          <div className='py-20'>
            <div className='container mx-auto px-4'>
              <div className='max-w-4xl mx-auto text-center'>
                ...
                <button
                  onClick={handleGetStarted}
                  className='inline-flex items-center px-8 py-4 bg-pink-400 text-white font-semibold rounded-lg hover:bg-pink-500 transition-colors duration-200 text-lg'
                >
