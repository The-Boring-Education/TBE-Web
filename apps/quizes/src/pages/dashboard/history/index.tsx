            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>
                  {
                    formatDate({
                      dateAndTime: attempt.completedAt,
                    }).date
                  }
                </span>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {Math.round(
                        (attempt.pointsEarned / attempt.timeTaken) * 60,
                      )}{" "}
                      pts/min
                    </span>
                  </div>
...
function HistoryContent() {
  ...
  const categories = Array.from(
    new Set(attempts.map((attempt) => attempt.categoryName)),
  );
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            >
              <RefreshCw
                className={`w-4 h-4 mr-2 ${attemptsLoading ? "animate-spin" : ""}`}
              />
              Refresh
            </Button>
          </div>
          ...
          {attemptsLoading ? (
            ...
            <div className="space-y-4">
              {filteredAttempts.map((attempt, index) => (
                ...
                >
                  <AttemptCard attempt={attempt} showDetails={showDetails} />
                </div>
              ))}
            </div>
          )}
