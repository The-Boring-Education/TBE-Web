          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-16">
                ...
                <h1 className="text-6xl md:text-8xl font-bold text-black mb-2 leading-none">
                  Quizes
                </h1>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-black-600 leading-relaxed">
                      Hand-picked questions covering the most important topics
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-gray-600">
                    Join thousands of developers who have improved their
                    interview skills.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div className="border-2 border-black rounded-lg p-8 bg-white shadow">
                    ...
                    <div className="text-black">Practice Questions</div>
                  </div>
                  <div className="border-2 border-black rounded-lg p-8 bg-white shadow">
                    <div className="flex items-center justify-center mb-4">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-gray-600">
                    Practice questions tailored to specific technologies and
                    concepts.
                  </p>
                </div>
