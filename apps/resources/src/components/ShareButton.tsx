  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="flex items-center gap-1.5 rounded-md border border-zinc-700 bg-zinc-800/60 px-3 py-1.5 text-sm text-zinc-300 transition hover:border-zinc-500 hover:text-white"
