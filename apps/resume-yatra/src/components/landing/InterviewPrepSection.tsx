        ...
        <div className="max-w-6xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Prepare for Interviews with Our{" "}
              <span className="text-primary">Interview Prep</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Don't just fix your resume—master the entire hiring process. Get
              interview-ready with our comprehensive preparation platform.
            </p>
          </div>
            ...
            <div className="bg-white border-2 border-primary rounded-2xl p-8 relative overflow-hidden">
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-gray-600">
                  Join thousands who've successfully cracked interviews at top
                  tech companies
                </p>
