...
export const useOnboarding = ({
  ...
  const handleNext = () => {
    try {
      trackEvent("onboarding_next", { category: "onboarding", step });
    } catch {
  ...
  const handleBack = () => {
    try {
      trackEvent("onboarding_previous", { category: "onboarding", step });
    } catch {
      /* Ignore tracking errors */
    }
  ...
  const handleFinish = async () => {
    ...
    setError("");
    try {
      trackEvent("onboarding_submit", { category: "onboarding" });
    } catch {
      /* Ignore tracking errors */
    }
    ...
    if (success) {
      try {
        trackEvent("onboarding_complete", { category: "onboarding" });
      } catch {
        /* Ignore tracking errors */
      }
