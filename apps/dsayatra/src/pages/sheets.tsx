...
const SheetsPageClient = () => {
    ...
    return (
        <FlexContainer direction="col" className="flex-1 min-h-0 w-full bg-[#0A0A0A] h-[calc(100vh-72px)] mt-0 font-sans" itemCenter={false} justifyCenter={false} wrap={false}>
            <FlexContainer direction="col" className="lg:flex-row flex-1 min-h-0 w-full" itemCenter={false} justifyCenter={false} wrap={false}>
                {/* Left Sidebar - Topics or Questions */}
                <div className={`flex flex-col flex-shrink-0 border-r border-[#2a2a2a] bg-black transition-all duration-300 ${selectedTopic ? 'w-full lg:w-[350px]' : 'flex-1 lg:flex-none w-full lg:w-[340px]'}`}>
                    <div className="flex-1 overflow-y-auto px-5 py-5 scrollbar-thin-grey">
                        {!selectedTopic ? (
                            <div className="flex flex-col">
                                ...
                                />
                                <div className="mb-4">
                                    <h1 className="text-[24px] font-bold text-white">Explore Topics</h1>
                                    <p className="text-[13px] text-gray-400">Choose a Topic to Begin</p>
                                </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center gap-4 min-w-0">
                                                    ...
                                                    <Text level="p" className={cn("text-[15px] font-bold truncate transition-colors", isCompleted ? "text-green-500" : "text-white")}>
                                                        {label}
                                                    </Text>
                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mb-1">
                                    <h1 className="mt-2 text-xl font-bold text-white">Questions in {TOPIC_LABELS[selectedTopic] || selectedTopic}</h1>
                                    <p className="mb-4 text-xs text-gray-400 mt-1">Select a question to view details</p>
                ...
                <div className={`flex-1 flex flex-col min-w-0 bg-[#0A0A0A] ${!selectedTopic ? 'hidden lg:flex' : 'flex'}`}>
                    <div className="flex-1 overflow-y-auto scrollbar-thin-grey px-4 py-4 scroll-smooth" id="right-scroll-area">
                        {!selectedTopic ? (
