...
import { DsaPricingFaqItem } from "../components/dsa-pricing/DsaPricingFaqItem";
import { DsaPricingPlanCard } from "../components/dsa-pricing/DsaPricingPlanCard";
import {
  DSA_PRICING_FAQS,
  DSA_PRICING_STATS,
    ...
    const fetchPlans = async () => {
      ...
      try {
        const res = await sendRequest({
          method: "GET",
          url: buildDsaSubscriptionPlansRequestUrl(DSA_YATRA_PRODUCT_TYPE),
        });
        ...
        setPlans(normalizePlansForPricing(res.data));
      } catch (err) {
          ...
          <>
            ...
            <section className="max-w-xl mx-auto px-4 py-12">
              ...
              <div className="space-y-2">
                {DSA_PRICING_FAQS.map((faq, i) => (
                  <DsaPricingFaqItem key={i} q={faq.q} a={faq.a} index={i} />
                ))}
              </div>
            </section>
