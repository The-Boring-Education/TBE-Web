...
export const OnboardingCheck = () => {
    ...
    useEffect(() => {
        ...
        if (!isLoading && isAuthenticated && user && !hasChecked.current && !isChecking) {
            const checkOnboardingStatus = async () => {
                ...
                try {
                    ...
                    if (!isOnboarded) {
                        const onboardingBaseUrl = process.env.NEXT_PUBLIC_ONBOARDING_URL || process.env.NEXT_PUBLIC_ONBOARDING_APP_URL;
