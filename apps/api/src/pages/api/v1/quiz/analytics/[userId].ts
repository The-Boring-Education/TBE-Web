                ...
                difficultyPerformance: {
                    easy: {
                        ...
                        successRate: Math.round(
                            analytic.difficultyPerformance.easy.successRate *
                                100
                        )
                    },
                    medium: {
                        attempts:
                            analytic.difficultyPerformance.medium.attempts,
                        successRate: Math.round(
                            analytic.difficultyPerformance.medium.successRate *
                                100
                        )
                    },
                    hard: {
                        ...
                        successRate: Math.round(
                            analytic.difficultyPerformance.hard.successRate *
                                100
                        )
                    }
                },
                progressTimeline: analytic.progressTimeline.map(
                    (entry: any) => ({
                        date: entry.date,
                        score: entry.score,
