        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.theboringeducation.com https://www.google-analytics.com https://analytics.google.com https://*.google-analytics.com https://*.google.com https://*.sentry.io https://sdk.cashfree.com https://*.cashfree.com",
              "worker-src 'self' blob:",
              "frame-src 'self' https://www.youtube.com https://sdk.cashfree.com https://*.cashfree.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self' https://*.cashfree.com https://sandbox.cashfree.com https://api.cashfree.com",
            ].join('; '),
          },
        ],
      },
