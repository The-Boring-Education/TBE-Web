    ...
    <div className=" py-8 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-primary mb-1">Available Quizzes</h1>
        ...
        {categories.length === 0 ? (
          <div className="text-center py-2">
            <p className="text-gray-400 text-sm mb-1">No quizzes available right now.</p>
            <Button
              onClick={refetch}
              variant="OUTLINE"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {categories.map((category: QuizCategoryAPI) => (
              ...
              >
                <div className="relative bg-black rounded-lg overflow-hidden border border-gray-800 hover:border-[#ff5757]/50 transition-all duration-300 shadow-lg hover:shadow-lg" style={{ boxShadow: '0 0 20px rgba(255, 87, 87, 0.1)' }}>
