...
const AdminDashboard = () => {
  const { data: overviewData, loading: overviewLoading, fetchData: fetchOverview } = useAdminData();
  const { data: analyticsData, loading: analyticsLoading, fetchData: fetchAnalytics } = useAdminData();
  const { data: revenueData, loading: revenueLoading, fetchData: fetchRevenue } = useAdminData();
  const { data: userGrowthData, loading: userGrowthLoading, fetchData: fetchUserGrowth } = useAdminData();
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Project Enrollments</div>
                </div>
              </div>
            </div>
