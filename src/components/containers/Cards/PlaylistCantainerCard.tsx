...
import { Section, PlaylistVideoCard, PlaylistCard, Button } from "@/components";
        ...
        <div className="flex justify-center p-2">
          {playlistVideo && (
            <PlaylistVideoTimeCard
              usertime={playlistData.learningTime}
              playlistId={actualPlaylist._id}
            />
          )}
        </div>

>>>>>>> 76c293738e4772d3fa213adc57bdb7b60c676789
        <div className="w-full">
          <PlaylistCard
